...
Scan for connected storage arrays and volumes securely bound via contexts

```
qxctl storage scan [flags]
```
...
* [qxctl storage](qxctl_storage.md)	 - Manage connected storage and databases natively
