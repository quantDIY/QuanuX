...
Create remote pushing current project

```
qxctl vcs publish [provider] [flags]
```
...
* [qxctl vcs](qxctl_vcs.md)	 - Version Control System Connectors natively bound without memory leaks
