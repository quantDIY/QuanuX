...
Manage Analytical Extensions (Validate & Estimate SQL)
...
* [qxctl query estimate](qxctl_query_estimate.md)	 - Transpiles AST and hits BigQuery Dry-Run API for metrics natively
* [qxctl query validate](qxctl_query_validate.md)	 - Parses local DuckDB SQL
