## qxctl topstepx market-hub

Set SignalR Market Hub URL

```
qxctl topstepx market-hub [url] [flags]
```

### Options

```
  -h, --help   help for market-hub
```
...
* [qxctl topstepx](qxctl_topstepx.md)	 - Manage TopstepX Extension natively
