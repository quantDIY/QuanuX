...
Manage the global QuanuX configuration natively
...
* [qxctl config init](qxctl_config_init.md)	 - Initialize a default ~/.qxctl.yaml config file
* [qxctl config view](qxctl_config_view.md)	 - View the active configuration struct
