...
[skills](/)/ [dchuk](/dchuk)/ [claude-code-tauri-skills](/dchuk/claude-code-tauri-skills)/understanding-tauri-architecture
...
ComponentRole**Core (Rust)**System access, security, business logic**Shell (Frontend)**UI rendering, user interaction**WebView (TAO+WRY)**Platform-native rendering bridge**IPC (Commands/Events)**Safe message passing between layers**Capabilities**Permission control per window
...
[dchuk/claude-co…i-skills](https://github.com/dchuk/claude-code-tauri-skills "dchuk/claude-code-tauri-skills")
...
[Gen Agent Trust HubFail](/dchuk/claude-code-tauri-skills/understanding-tauri-architecture/security/agent-trust-hub) [SocketPass](/dchuk/claude-code-tauri-skills/understanding-tauri-architecture/security/socket) [SnykPass](/dchuk/claude-code-tauri-skills/understanding-tauri-architecture/security/snyk)
