...
[skills](/)/ [google-labs-code](/google-labs-code)/ [stitch-skills](/google-labs-code/stitch-skills)/shadcn-ui
...
- **Full ownership**: Components live in your codebase, not node\_modules
...
[Gen Agent Trust HubPass](/google-labs-code/stitch-skills/shadcn-ui/security/agent-trust-hub) [SocketPass](/google-labs-code/stitch-skills/shadcn-ui/security/socket) [SnykWarn](/google-labs-code/stitch-skills/shadcn-ui/security/snyk)
