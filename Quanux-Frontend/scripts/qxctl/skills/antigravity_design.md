antigravity-design-expert by sickn33/antigravity-awesome-skills

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [sickn33](/sickn33)/ [antigravity-awesome-skills](/sickn33/antigravity-awesome-skills)/antigravity-design-expert

# antigravity-design-expert

`$ npx skills add https://github.com/sickn33/antigravity-awesome-skills --skill antigravity-design-expert`

SKILL.md

* * *

## name: antigravity-design-expert description: Core UI/UX engineering skill for building highly interactive, spatial, weightless, and glassmorphism-based web interfaces using GSAP and 3D CSS. risk: safe source: community date\_added: "2026-03-07"
...
[Gen Agent Trust HubPass](/sickn33/antigravity-awesome-skills/antigravity-design-expert/security/agent-trust-hub) [SocketPass](/sickn33/antigravity-awesome-skills/antigravity-design-expert/security/socket) [SnykPass](/sickn33/antigravity-awesome-skills/antigravity-design-expert/security/snyk)
