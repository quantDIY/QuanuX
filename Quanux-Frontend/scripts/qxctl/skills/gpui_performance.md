gpui-performance by geoffjay/claude-plugins

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [geoffjay](/geoffjay)/ [claude-plugins](/geoffjay/claude-plugins)/gpui-performance
...
01. **Measure First**: Profile before optimizing
02. **Minimize Renders**: Only `cx.notify()` when necessary
03. **Cache Results**: Memoize expensive computations
04. **Batch Updates**: Group state changes
05. **Virtual Scrolling**: For long lists
06. **Flat Layouts**: Avoid deep nesting
07. **Fixed Sizing**: When possible
08. **Monitor Memory**: Watch for leaks
09. **Async Loading**: Don't block UI
...
[Gen Agent Trust HubFail](/geoffjay/claude-plugins/gpui-performance/security/agent-trust-hub) [SocketPass](/geoffjay/claude-plugins/gpui-performance/security/socket) [SnykPass](/geoffjay/claude-plugins/gpui-performance/security/snyk)
