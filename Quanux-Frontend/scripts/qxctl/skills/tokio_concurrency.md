tokio-concurrency by geoffjay/claude-plugins

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [geoffjay](/geoffjay)/ [claude-plugins](/geoffjay/claude-plugins)/tokio-concurrency
...
01. **Use appropriate concurrency limits** \- Don't spawn unbounded tasks
02. **Implement backpressure** \- Use bounded channels and semaphores
03. **Handle cancellation** \- Support cooperative cancellation with tokens
04. **Avoid lock contention** \- Minimize lock scope, prefer channels
05. **Use rate limiting** \- Protect external services
06. **Implement circuit breakers** \- Prevent cascading failures
07. **Batch operations** \- Reduce overhead for small operations
08. **Profile concurrency** \- Use tokio-console to understand behavior
09. **Use appropriate synchronization** \- RwLock for read-heavy, Mutex for write-heavy
...
[geoffjay/claude-plugins](https://github.com/geoffjay/claude-plugins "geoffjay/claude-plugins")
...
[Gen Agent Trust HubPass](/geoffjay/claude-plugins/tokio-concurrency/security/agent-trust-hub) [SocketPass](/geoffjay/claude-plugins/tokio-concurrency/security/socket) [SnykPass](/geoffjay/claude-plugins/tokio-concurrency/security/snyk)
