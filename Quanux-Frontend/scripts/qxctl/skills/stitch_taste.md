taste-design by google-labs-code/stitch-skills

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [google-labs-code](/google-labs-code)/ [stitch-skills](/google-labs-code/stitch-skills)/taste-design
...
[Gen Agent Trust HubPass](/google-labs-code/stitch-skills/taste-design/security/agent-trust-hub) [SocketPass](/google-labs-code/stitch-skills/taste-design/security/socket) [SnykPass](/google-labs-code/stitch-skills/taste-design/security/snyk)
