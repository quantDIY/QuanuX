tokio-patterns by geoffjay/claude-plugins

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [geoffjay](/geoffjay)/ [claude-plugins](/geoffjay/claude-plugins)/tokio-patterns
...
01. **Use semaphores** for limiting concurrent operations
02. **Implement graceful shutdown** in all long-running tasks
03. **Add timeouts** to external operations
04. **Use channels** for inter-task communication
05. **Handle cancellation** properly in all tasks
06. **Clean up resources** in Drop or explicit shutdown methods
07. **Use appropriate channel types** for different patterns
08. **Implement retries** for transient failures
09. **Use select!** for coordinating multiple async operations
...
[Gen Agent Trust HubPass](/geoffjay/claude-plugins/tokio-patterns/security/agent-trust-hub) [SocketPass](/geoffjay/claude-plugins/tokio-patterns/security/socket) [SnykPass](/geoffjay/claude-plugins/tokio-patterns/security/snyk)
