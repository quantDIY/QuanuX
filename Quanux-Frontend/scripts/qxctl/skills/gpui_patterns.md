gpui-patterns by geoffjay/claude-plugins

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [geoffjay](/geoffjay)/ [claude-plugins](/geoffjay/claude-plugins)/gpui-patterns
...
- GPUI GitHub: [https://github.com/zed-industries/zed/tree/main/crates/gpui](https://github.com/zed-industries/zed/tree/main/crates/gpui)
...
[Gen Agent Trust HubFail](/geoffjay/claude-plugins/gpui-patterns/security/agent-trust-hub) [SocketPass](/geoffjay/claude-plugins/gpui-patterns/security/socket) [SnykPass](/geoffjay/claude-plugins/gpui-patterns/security/snyk)
