tokio-troubleshooting by geoffjay/claude-plugins

[Made with love by Vercel](https://vercel.com "Made with love by Vercel")[Skills](/)

[OfficialNew](/official) [Audits](/audits) [Docs](/docs)

[skills](/)/ [geoffjay](/geoffjay)/ [claude-plugins](/geoffjay/claude-plugins)/tokio-troubleshooting
...
### Deadlock Detection with try\_lock
...
- Use try\_lock to detect potential deadlocks
...
01. **Always use tokio-console** in development
02. **Add tracing spans** to critical code paths
03. **Use timeouts** liberally to detect hangs
04. **Monitor task count** for leaks
05. **Profile before optimizing** \- measure first
06. **Test with real concurrency** \- don't just test happy paths
07. **Handle cancellation** gracefully in all tasks
08. **Use structured logging** for debugging
09. **Avoid nested locks** \- prefer message passing
...
[Gen Agent Trust HubFail](/geoffjay/claude-plugins/tokio-troubleshooting/security/agent-trust-hub) [SocketPass](/geoffjay/claude-plugins/tokio-troubleshooting/security/socket) [SnykPass](/geoffjay/claude-plugins/tokio-troubleshooting/security/snyk)
