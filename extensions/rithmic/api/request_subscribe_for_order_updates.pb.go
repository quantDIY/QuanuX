...
const file_request_subscribe_for_order_updates_proto_rawDesc = "" +
	"\n" +
	")request_subscribe_for_order_updates.proto\x12\x03rti\"\xb2\x01\n" +
	"\x1fRequestSubscribeForOrderUpdates\x12!\n" +
...
var (
	...
	file_request_subscribe_for_order_updates_proto_rawDescData []byte
)
...
func file_request_subscribe_for_order_updates_proto_rawDescGZIP() []byte {
	file_request_subscribe_for_order_updates_proto_rawDescOnce.Do(func() {
		file_request_subscribe_for_order_updates_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_request_subscribe_for_order_updates_proto_rawDesc), len(file_request_subscribe_for_order_updates_proto_rawDesc)))
	})
...
func file_request_subscribe_for_order_updates_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_request_subscribe_for_order_updates_proto_rawDesc), len(file_request_subscribe_for_order_updates_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
