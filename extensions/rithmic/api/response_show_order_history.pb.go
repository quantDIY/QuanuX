...
const file_response_show_order_history_proto_rawDesc = "" +
	"\n" +
	"!response_show_order_history.proto\x12\x03rti\"u\n" +
	"\x18ResponseShowOrderHistory\x12!\n" +
...
var (
	...
	file_response_show_order_history_proto_rawDescData []byte
)

func file_response_show_order_history_proto_rawDescGZIP() []byte {
	file_response_show_order_history_proto_rawDescOnce.Do(func() {
		file_response_show_order_history_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_response_show_order_history_proto_rawDesc), len(file_response_show_order_history_proto_rawDesc)))
	})
...
var file_response_show_order_history_proto_goTypes = []any{
...
func file_response_show_order_history_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_response_show_order_history_proto_rawDesc), len(file_response_show_order_history_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
