...
const file_request_list_unaccepted_agreements_proto_rawDesc = "" +
	"\n" +
	"(request_list_unaccepted_agreements.proto\x12\x03rti\"a\n" +
	"\x1fRequestListUnacceptedAgreements\x12!\n" +
...
var (
	...
	file_request_list_unaccepted_agreements_proto_rawDescData []byte
)
...
func file_request_list_unaccepted_agreements_proto_rawDescGZIP() []byte {
	file_request_list_unaccepted_agreements_proto_rawDescOnce.Do(func() {
		file_request_list_unaccepted_agreements_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_request_list_unaccepted_agreements_proto_rawDesc), len(file_request_list_unaccepted_agreements_proto_rawDesc)))
	})
...
var file_request_list_unaccepted_agreements_proto_goTypes = []any{
...
func file_request_list_unaccepted_agreements_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_request_list_unaccepted_agreements_proto_rawDesc), len(file_request_list_unaccepted_agreements_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
