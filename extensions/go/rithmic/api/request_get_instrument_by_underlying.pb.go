...
const file_request_get_instrument_by_underlying_proto_rawDesc = "" +
	"\n" +
	"*request_get_instrument_by_underlying.proto\x12\x03rti\"\xda\x01\n" +
	" RequestGetInstrumentByUnderlying\x12!\n" +
...
var (
	...
	file_request_get_instrument_by_underlying_proto_rawDescData []byte
)
...
func file_request_get_instrument_by_underlying_proto_rawDescGZIP() []byte {
	file_request_get_instrument_by_underlying_proto_rawDescOnce.Do(func() {
		file_request_get_instrument_by_underlying_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_request_get_instrument_by_underlying_proto_rawDesc), len(file_request_get_instrument_by_underlying_proto_rawDesc)))
	})
...
func file_request_get_instrument_by_underlying_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_request_get_instrument_by_underlying_proto_rawDesc), len(file_request_get_instrument_by_underlying_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
