...
const file_response_cancel_all_orders_proto_rawDesc = "" +
	"\n" +
	" response_cancel_all_orders.proto\x12\x03rti\"t\n" +
	"\x17ResponseCancelAllOrders\x12!\n" +
...
var (
	...
	file_response_cancel_all_orders_proto_rawDescData []byte
)

func file_response_cancel_all_orders_proto_rawDescGZIP() []byte {
	file_response_cancel_all_orders_proto_rawDescOnce.Do(func() {
		file_response_cancel_all_orders_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_response_cancel_all_orders_proto_rawDesc), len(file_response_cancel_all_orders_proto_rawDesc)))
	})
...
func file_response_cancel_all_orders_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_response_cancel_all_orders_proto_rawDesc), len(file_response_cancel_all_orders_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
