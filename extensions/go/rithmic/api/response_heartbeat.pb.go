...
const file_response_heartbeat_proto_rawDesc = "" +
	"\n" +
	"\x18response_heartbeat.proto\x12\x03rti\"\x9e\x01\n" +
	"\x11ResponseHeartbeat\x12!\n" +
	"\vtemplate_id\x18\xe3\xb6\t \x02(\x05R\n" +
	"templateId\x12\x1b\n" +
	"\buser_msg\x18\x98\x8d\b \x03(\tR\auserMsg\x12\x19\n" +
	"\arp_code\x18\x9e\x8d\b \x03(\tR\x06rpCode\x12\x16\n" +
...
var (
	...
	file_response_heartbeat_proto_rawDescData []byte
)

func file_response_heartbeat_proto_rawDescGZIP() []byte {
	file_response_heartbeat_proto_rawDescOnce.Do(func() {
		file_response_heartbeat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_response_heartbeat_proto_rawDesc), len(file_response_heartbeat_proto_rawDesc)))
	})
	return file_response_heartbeat_proto_rawDescData
}

var file_response_heartbeat_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_response_heartbeat_proto_goTypes = []any{
...
func file_response_heartbeat_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_response_heartbeat_proto_rawDesc), len(file_response_heartbeat_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
