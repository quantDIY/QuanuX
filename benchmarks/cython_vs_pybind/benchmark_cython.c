...
#define __PYX_HAVE__bench_cython
#define __PYX_HAVE_API__bench_cython
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "bench_cython" */
static int __pyx_f_12bench_cython_add(int, int, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "bench_cython"
extern int __pyx_module_is_main_bench_cython;
int __pyx_module_is_main_bench_cython = 0;

/* Implementation of "bench_cython" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12bench_cython_add(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_i, int __pyx_v_j); /* proto */
...
#define __pyx_kp_u_benchmark_cython_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_add __pyx_string_tab[3]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[4]
#define __pyx_n_u_bench_cython __pyx_string_tab[5]
...
#define __pyx_kp_b_iso88591_Q_2Rq __pyx_string_tab[21]
...
static PyObject *__pyx_pw_12bench_cython_1add(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static int __pyx_f_12bench_cython_add(int __pyx_v_i, int __pyx_v_j, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_r;

  /* "benchmark_cython.pyx":2
 * cpdef int add(int i, int j):
 *     return i + j             # <<<<<<<<<<<<<<
*/
...
static PyMethodDef __pyx_mdef_12bench_cython_1add = {"add", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12bench_cython_1add, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12bench_cython_1add(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "add", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("add", 1, 2, 2, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
    ...
    __pyx_v_i = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_i == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L3_error)
    __pyx_v_j = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_j == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  ...
  __Pyx_AddTraceback("bench_cython.add", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12bench_cython_add(__pyx_self, __pyx_v_i, __pyx_v_j);
...
static PyObject *__pyx_pf_12bench_cython_add(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_i, int __pyx_v_j) {
  ...
  __pyx_t_1 = __pyx_f_12bench_cython_add(__pyx_v_i, __pyx_v_j, 1); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __pyx_pymod_exec_bench_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bench_cython},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_bench_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bench_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bench_cython(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bench_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "bench_cython" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_bench_cython", 0);
  ...
  if (__pyx_module_is_main_bench_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bench_cython")) {
      if (unlikely((PyDict_SetItemString(modules, "bench_cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     return i + j
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12bench_cython_1add, 0, __pyx_mstate_global->__pyx_n_u_add, NULL, __pyx_mstate_global->__pyx_n_u_bench_cython, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_add, __pyx_t_2) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init bench_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init bench_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{20},{20},{3},{18},{12},{18},{8},{1},{13},{5},{1},{8},{10},{8},{3},{12},{12},{10},{8},{6},{13}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (161 bytes) */
const char* const cstring = "x\332=\216;\016\302@\014D\033:\304URp\001\032j\024r\201\221\343u\224%\373I\262^\224t\2249\"\307a\371\010\027\343\261=O\362\251\225\300\275\247y\000\257\332\307P\215\353\002\324E\352\365lYq\221E\033\351\310\030Jk`\033+\216s\314j\203\244\017\374\003\331\225\rl\200\316\304\322\022\017@\227\003\003\0266\341\017Y\025\237n\200\247\222-\345\243\311N\336.\220/}\214#0er\337\021H\242\277Sq\246|\222\235\002*\251\350\235\\\226\3648l\327\347n\277\035\267f\233^\330uT\215";
    PyObject *data = __Pyx_DecompressString(cstring, 161, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (210 bytes) */
const char* const bytes = "?benchmark_cython.pyx__Pyx_PyDict_NextRefaddasyncio.coroutinesbench_cythoncline_in_traceback__func__i_is_coroutineitemsj__main____module____name__pop__qualname____set_name__setdefault__test__values\200\r\210Q\330\004\013\2102\210R\210q";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_benchmark_cython_pyx, __pyx_mstate->__pyx_n_u_add, __pyx_mstate->__pyx_kp_b_iso88591_Q_2Rq, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
