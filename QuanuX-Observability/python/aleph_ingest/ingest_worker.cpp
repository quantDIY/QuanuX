...
#define __PYX_HAVE__ingest_worker
#define __PYX_HAVE_API__ingest_worker
/* Early includes */
#include <string.h>
#include <string_view>
#include "ios"
...
/* Module declarations from "ingest_worker" */
...
#define __Pyx_MODULE_NAME "ingest_worker"
extern int __pyx_module_is_main_ingest_worker;
int __pyx_module_is_main_ingest_worker = 0;

/* Implementation of "ingest_worker" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_13ingest_worker_process_jetstream_payload(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_payload); /* proto */
...
#define __pyx_kp_u_ingest_worker_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_ingest_worker __pyx_string_tab[8]
...
#define __pyx_n_u_payload __pyx_string_tab[14]
#define __pyx_n_u_pop __pyx_string_tab[15]
#define __pyx_n_u_process_jetstream_payload __pyx_string_tab[16]
...
#define __pyx_kp_b_iso88591_q_Yc_6 __pyx_string_tab[23]
...
/* Python wrapper */
static PyObject *__pyx_pw_13ingest_worker_1process_jetstream_payload(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_13ingest_worker_process_jetstream_payload, "\n    Takes a raw JSON payload (bytes) directly from JetStream and securely \n    converts it to the Aleph zero-space Markdown Standard via native C++ \n    JSON bindings, bypassing Python GIL manipulation loops in the hot path.\n    ");
static PyMethodDef __pyx_mdef_13ingest_worker_1process_jetstream_payload = {"process_jetstream_payload", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_13ingest_worker_1process_jetstream_payload, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_13ingest_worker_process_jetstream_payload};
static PyObject *__pyx_pw_13ingest_worker_1process_jetstream_payload(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("process_jetstream_payload (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "process_jetstream_payload", 0) < (0)) __PYX_ERR(0, 9, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("process_jetstream_payload", 1, 1, 1, i); __PYX_ERR(0, 9, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("process_jetstream_payload", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("ingest_worker.process_jetstream_payload", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_payload), (&PyBytes_Type), 1, "payload", 1))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_r = __pyx_pf_13ingest_worker_process_jetstream_payload(__pyx_self, __pyx_v_payload);
...
static PyObject *__pyx_pf_13ingest_worker_process_jetstream_payload(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_payload) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("process_jetstream_payload", 0);

  /* "ingest_worker.pyx":15
 *     JSON bindings, bypassing Python GIL manipulation loops in the hot path.
 *     """
...
*/
  ...
  __pyx_t_1 = __Pyx_PyBytes_AsString(__pyx_v_payload); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
  if (unlikely(__pyx_v_payload == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 15, __pyx_L1_error)
  }
  __pyx_t_2 = __Pyx_PyBytes_GET_SIZE(__pyx_v_payload); if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
  try {
    __pyx_t_3 = format_payload(((char const *)__pyx_t_1), __pyx_t_2);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 15, __pyx_L1_error)
  }
  ...
  /* "ingest_worker.pyx":16
 *     """
 *     cdef string result = format_payload(<const char*>payload, len(payload))
 *     return result.decode('utf-8')             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_decode_cpp_string(__pyx_v_result, 0, PY_SSIZE_T_MAX, NULL, NULL, PyUnicode_DecodeUTF8); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static int __pyx_pymod_exec_ingest_worker(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ingest_worker},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_ingest_worker(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ingest_worker(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ingest_worker(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ingest_worker' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "ingest_worker" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_ingest_worker", 0);
  ...
  if (__pyx_module_is_main_ingest_worker) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ingest_worker")) {
      if (unlikely((PyDict_SetItemString(modules, "ingest_worker", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     Takes a raw JSON payload (bytes) directly from JetStream and securely
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_13ingest_worker_1process_jetstream_payload, 0, __pyx_mstate_global->__pyx_n_u_process_jetstream_payload, NULL, __pyx_mstate_global->__pyx_n_u_ingest_worker, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_process_jetstream_payload, __pyx_t_2) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init ingest_worker", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init ingest_worker");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{17},{20},{18},{18},{8},{13},{13},{5},{8},{10},{8},{7},{3},{25},{12},{6},{12},{10},{8},{6},{32}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (393 bytes) */
const char* const cstring = "BZh91AY&SY1s\272\252\000\000\032\377\376\346\016 \221`\203\005@\217!P \277\377\377\340@@@@@@@@@\000\000@@\0000\001,\325X\212\207\204\324\323\365\020\003\021\240\000\032\030C\324\3653L\240\324\320\236\232\232d\2154e\032\030\0020\214\231\003L\000j`\243\021F\3154\246A\220\320\000\000\0327\251\001\243\005%\206q\253;V$\346\232\"\243<\211\214\277H\347\202\324PP\211-\034\356\336\233\\\210@\334\341\315\262Zc}\2064t\366\"\t\376\230?\303q\020\306\375^\363L\304\362 \225\241M\r[\355\003\240\tE_\031s\225|\036{6\254v\2