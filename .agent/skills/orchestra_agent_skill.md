...
1. **ISO 20022 (FIX Orchestra):** Universal protocol naming definitions generated by the pure C++ `pugixml` native standardizer. You must prefer referencing standardized Tag Names (e.g., `ClOrdID`, `TransactTime`) instead of numerical values.
